...
inline eb_establish_timing(struct eb_established_timing *et, int x, int y, int r, int valid)
{
	if (valid) {
		et->valid = 1;
		et->width = x;
...
inline eb_establish_timing_i(struct eb_established_timing *et, int x, int y, int r, int valid)
{
	if (valid) {
		et->valid = 1;
		et->width = x;
...
inline eb_establish_timing_rb(struct eb_established_timing *et, int x, int y, int r, int valid)
{
	if (valid) {
		et->valid = 1;
		et->width = x;
